<#
    --------------------------------------------------------------------------------
     Generated on:       24/12/2022 10:12 pm
     Generated by:       Costas Katsavounidis MA, MSc, CFCE, CAWFE, ICMDE
		...
		$data = switch ($column.Coltyp.ToString())
				{
					...
					'LongText'{ [Microsoft.Isam.Esent.Interop.Api]::RetrieveColumnAsString($Session, $Table, $column.Columnid, [System.Text.Encoding]::GetEncoding($column.Cp), [Microsoft.Isam.Esent.Interop.RetrieveColumnGrbit]::RetrieveIgnoreDefault); break }
					'Binary'{ $Binarydata = [Microsoft.Isam.Esent.Interop.Api]::RetrieveColumn($Session, $Table, $column.Columnid, [Microsoft.Isam.Esent.Interop.RetrieveColumnGrbit]::RetrieveIgnoreDefault, $null)
						if (!!$Binarydata -and $Column.MaxLength -eq 8)
						{
						...
						elseif(!!$Binarydata){ [System.BitConverter]::ToString($Binarydata).Replace('-', ''); break }
						else { $null; break}
					}
					'LongBinary'{
					...
					'Guid'{ [Microsoft.Isam.Esent.Interop.Api]::RetrieveColumnAsGuid($Session, $Table, $column.Columnid, [Microsoft.Isam.Esent.Interop.RetrieveColumnGrbit]::RetrieveIgnoreDefault); break }
...

EPIHwm55/XM1sZ4AAAAASUVORK5CYIIL'))
	#endregion
...
AAAADwMAAACSaAAAAk1TRnQBSQFMAgEBDgEAAbgBAAG4AQABGAEAARgBAAT/ASEBAAj/AUIBTQE2
BwABNgMAASgDAAFgAwABYAMAAQEBAAEgBgABkE4AAwYBCAMbASYBVQFZAVcBuQEPAVkBGQH7ARwB
UQEdAfcDTgGZAw8BFAMFAQb/AE0AAwsBDgMWAR4DEwEaAwwBEAMDAQQDRQF8AQABYAEJAf8BAAF4
...
DAEQAcYBxQHCA/8B/gH/AcgBxgHEAf8BwQG/AbwB/wFdAWIBXwHHAQABmgEeAf8BAAGEARAN/wEA
...

...

...

...

...

...

...

...

...
'))
	#endregion
...

...
Af8BgAGBAYAB/wGAAYEBgAH/AxIBGJgAAwwBEAL4AfcB/wHIAcYBxAH/AbMBrwGuAfsB3gFjARoB
/wHeAWMBGgP/AfwB/wG1AVEBEQH/Ad4BYwEaAf8BzAFSAQ4B/wQAAWABjgFOBf8BuAHjAasd/wHW
AeMBzQ3/AxsBJpgAAwwBEAL4AfcB/wHIAcYBxAH/AbMBsgGvAfsB7gF2ASkB/wHuAXYBKQX/AcgB
...

...
'))
	#endregion
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBSyWJvv7J8KZEn
# 8Rq7gnZk6roGS7LJCJxBikThnyZgbqCCKI0wggQyMIIDGqADAgECAgEBMA0GCSqG
...
# AQQBgjcCAQQwLwYJKoZIhvcNAQkEMSI